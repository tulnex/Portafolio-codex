...
function QuickLink({ icon, title, description }: QuickLinkProps) {
  return (
    <div className="bg-white rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition">
...
export default function RightSidebar() {
    ...
    },
    {
      icon: (
        <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14v7M4 9v5M20 9v5" />
        </svg>
      ),
      title: 'Academy',
  ...
  return (
    <aside className="w-80 bg-gray-100 p-6 h-screen fixed right-0 top-0 overflow-y-auto">
      <div className="flex items-center justify-between mb-6">
        <button className="w-10 h-10 flex items-center justify-center text-gray-600 hover:bg-gray-200 rounded-lg transition">
        ...
        <button className="px-4 py-2 bg-black text-white rounded-lg font-medium hover:bg-gray-800 transition flex items-center gap-2">
